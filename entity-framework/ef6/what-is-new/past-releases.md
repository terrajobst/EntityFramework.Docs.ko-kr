...
- 쿼리: EF 6.1.2의 회귀: 외부 적용은 1:1 관계 및 "let" 절에 대해 도입 되 고 더 복잡 한 쿼리
...
- 디자이너 EF6 디자이너에서 10 진수 전체 자릿수를 사용 하 여 EF5 edmx를 여는 동안 오류 발생
...
EF 5 릴리스에 특별히 적용 되는 콘텐츠 목록은 다음과 같습니다.
