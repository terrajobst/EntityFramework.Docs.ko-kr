...
<span data-ttu-id="0f7a1-144">합니다 **AssociationSet** 요소 (나열 된 순서로)는 다음 자식 요소를 포함할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-144">The **AssociationSet** element can have the following child elements (in the order listed):</span></span>
...
<span data-ttu-id="0f7a1-199">합니다 **종속** 요소 (나열 된 순서로)는 다음 자식 요소를 포함할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-199">The **Dependent** element can have the following child elements (in the order listed):</span></span>
...
## <a name="documentation-element-ssdl"></a><span data-ttu-id="0f7a1-216">Documentation 요소(SSDL)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-216">Documentation Element (SSDL)</span></span>
...
## <a name="end-element-ssdl"></a><span data-ttu-id="0f7a1-229">End 요소(SSDL)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-229">End Element (SSDL)</span></span>
...
<span data-ttu-id="0f7a1-265">합니다 **끝** 요소 (자식으로는 **AssociationSet** 요소) 기본 데이터베이스의 외래 키 제약 조건의 한 end에 있는 테이블을 지정 합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-265">The **End** element (as a child of the **AssociationSet** element) specifies a table at one end of a foreign key constraint in the underlying database.</span></span>
...
## <a name="entitycontainer-element-ssdl"></a><span data-ttu-id="0f7a1-285">EntityContainer 요소(SSDL)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-285">EntityContainer Element (SSDL)</span></span>
...
### <a name="example"></a><span data-ttu-id="0f7a1-306">예제</span><span class="sxs-lookup"><span data-stu-id="0f7a1-306">Example</span></span>
...
### <a name="applicable-attributes"></a><span data-ttu-id="0f7a1-318">적용 가능한 특성</span><span class="sxs-lookup"><span data-stu-id="0f7a1-318">Applicable Attributes</span></span>
...
## <a name="entitytype-element-ssdl"></a><span data-ttu-id="0f7a1-342">EntityType 요소(SSDL)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-342">EntityType Element (SSDL)</span></span>
...
<span data-ttu-id="0f7a1-365">다음 예제는 **EntityType** 두 속성이 있는 요소:</span><span class="sxs-lookup"><span data-stu-id="0f7a1-365">The following example shows an **EntityType** element with two properties:</span></span>
...
### <a name="applicable-attributes"></a><span data-ttu-id="0f7a1-378">적용 가능한 특성</span><span class="sxs-lookup"><span data-stu-id="0f7a1-378">Applicable Attributes</span></span>
...
| <span data-ttu-id="0f7a1-403">**IsComposable**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-403">**IsComposable**</span></span>           | <span data-ttu-id="0f7a1-404">아니요</span><span class="sxs-lookup"><span data-stu-id="0f7a1-404">No</span></span>          | <span data-ttu-id="0f7a1-405">**True** 기본 구성 가능 함수 이면<sup>3</sup> ; 함수 **False** 그렇지 않은 경우.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-405">**True** if the function is a composable<sup>3</sup> function; **False** otherwise.</span></span>                                                                                                                                |
...
<span data-ttu-id="0f7a1-425">합니다 **키** 요소 (SSDL) 저장소 스키마 정의 언어에서 기본 데이터베이스에서 테이블의 기본 키를 나타냅니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-425">The **Key** element in store schema definition language (SSDL) represents the primary key of a table in the underlying database.</span></span> <span data-ttu-id="0f7a1-426">**키** 테이블의 행을 나타내는 EntityType 요소의 자식 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-426">**Key** is a child element of an EntityType element, which represents a row in a table.</span></span> <span data-ttu-id="0f7a1-427">에 기본 키가 정의 합니다 **키** 에 정의 된 하나 이상의 속성 요소를 참조 하 여 요소를 **EntityType** 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-427">The primary key is defined in the **Key** element by referencing one or more Property elements that are defined on the **EntityType** element.</span></span>

<span data-ttu-id="0f7a1-428">합니다 **키** 요소 (나열 된 순서로)는 다음 자식 요소를 포함할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-428">The **Key** element can have the following child elements (in the order listed):</span></span>

-   <span data-ttu-id="0f7a1-429">PropertyRef (하나 이상)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-429">PropertyRef (one or more)</span></span>
-   <span data-ttu-id="0f7a1-430">Annotation 요소</span><span class="sxs-lookup"><span data-stu-id="0f7a1-430">Annotation elements</span></span>

<span data-ttu-id="0f7a1-431">적용할 수 없는 특성을 **키** 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-431">No attributes are applicable to the **Key** element.</span></span>

### <a name="example"></a><span data-ttu-id="0f7a1-432">예제</span><span class="sxs-lookup"><span data-stu-id="0f7a1-432">Example</span></span>

<span data-ttu-id="0f7a1-433">다음 예제는 **EntityType** 요소 하나의 속성을 참조 하는 키를 사용 하 여:</span><span class="sxs-lookup"><span data-stu-id="0f7a1-433">The following example shows an **EntityType** element with a key that references one property:</span></span>
...
## <a name="ondelete-element-ssdl"></a><span data-ttu-id="0f7a1-434">OnDelete 요소(SSDL)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-434">OnDelete Element (SSDL)</span></span>

<span data-ttu-id="0f7a1-435">합니다 **OnDelete** 요소 (SSDL) 저장소 스키마 정의 언어에서 외래 키 제약 조건에 관여 하는 행이 삭제 될 때 데이터베이스 동작을 나타냅니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-435">The **OnDelete** element in store schema definition language (SSDL) reflects the database behavior when a row that participates in a foreign key constraint is deleted.</span></span> <span data-ttu-id="0f7a1-436">작업 설정 된 경우 **Cascade**, 삭제 되는 행을 참조 하는 행도 삭제 됩니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-436">If the action is set to **Cascade**, then rows that reference a row that is being deleted will also be deleted.</span></span> <span data-ttu-id="0f7a1-437">작업 설정 된 경우 **None**, 후 삭제 되는 행을 참조 하는 행도 삭제 되지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-437">If the action is set to **None**, then rows that reference a row that is being deleted are not also deleted.</span></span> <span data-ttu-id="0f7a1-438">**OnDelete** 최종 요소의 자식 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-438">An **OnDelete** element is a child element of an End element.</span></span>

<span data-ttu-id="0f7a1-439">**OnDelete** 요소 (나열 된 순서로)는 다음 자식 요소를 포함할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-439">An **OnDelete** element can have the following child elements (in the order listed):</span></span>

-   <span data-ttu-id="0f7a1-440">설명서 (0 또는 1)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-440">Documentation (zero or one)</span></span>
-   <span data-ttu-id="0f7a1-441">Annotation 요소 (0 개 이상)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-441">Annotation elements (zero or more)</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="0f7a1-442">적용 가능한 특성</span><span class="sxs-lookup"><span data-stu-id="0f7a1-442">Applicable Attributes</span></span>

<span data-ttu-id="0f7a1-443">다음 표에서 설명에 적용할 수 있는 특성을 **OnDelete** 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-443">The following table describes the attributes that can be applied to the **OnDelete** element.</span></span>

| <span data-ttu-id="0f7a1-444">특성 이름</span><span class="sxs-lookup"><span data-stu-id="0f7a1-444">Attribute Name</span></span> | <span data-ttu-id="0f7a1-445">필수 여부</span><span class="sxs-lookup"><span data-stu-id="0f7a1-445">Is Required</span></span> | <span data-ttu-id="0f7a1-446">값</span><span class="sxs-lookup"><span data-stu-id="0f7a1-446">Value</span></span>                                                                                               |
|:---------------|:------------|:----------------------------------------------------------------------------------------------------|
| <span data-ttu-id="0f7a1-447">**작업**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-447">**Action**</span></span>     | <span data-ttu-id="0f7a1-448">예</span><span class="sxs-lookup"><span data-stu-id="0f7a1-448">Yes</span></span>         | <span data-ttu-id="0f7a1-449">**Cascade** 나 **None**합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-449">**Cascade** or **None**.</span></span> <span data-ttu-id="0f7a1-450">(값 **Restricted** 유효 하지만 동일한 동작 **None**.)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-450">(The value **Restricted** is valid but has the same behavior as **None**.)</span></span> |

> [!NOTE]
> <span data-ttu-id="0f7a1-451">주석 특성 (사용자 지정 XML 특성)을 개수에 관계 없이 적용할 수 있습니다 합니다 **OnDelete** 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-451">Any number of annotation attributes (custom XML attributes) may be applied to the **OnDelete** element.</span></span> <span data-ttu-id="0f7a1-452">그러나 사용자 지정 특성은 SSDL에 예약된 XML 네임스페이스에 속할 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-452">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="0f7a1-453">두 사용자 지정 특성의 정규화된 이름은 서로 같을 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-453">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="0f7a1-454">예제</span><span class="sxs-lookup"><span data-stu-id="0f7a1-454">Example</span></span>

<span data-ttu-id="0f7a1-455">에서는 다음 예제는 **연결** 정의 하는 요소는 **FK\_CustomerOrders** foreign key 제약 조건.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-455">The following example shows an **Association** element that defines the **FK\_CustomerOrders** foreign key constraint.</span></span> <span data-ttu-id="0f7a1-456">**OnDelete** 요소에서 모든 행을 나타냅니다는 **주문** 테이블에서 특정 행을 참조 하는 합니다 **고객** 경우 테이블은 삭제 됩니다 합니다 행**고객** 테이블이 삭제 됩니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-456">The **OnDelete** element indicates that all rows in the **Orders** table that reference a particular row in the **Customers** table will be deleted if the row in the **Customers** table is deleted.</span></span>
...
## <a name="parameter-element-ssdl"></a><span data-ttu-id="0f7a1-457">Parameter 요소(SSDL)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-457">Parameter Element (SSDL)</span></span>

<span data-ttu-id="0f7a1-458">합니다 **매개 변수** (SSDL) 저장소 스키마 정의 언어에서 요소는 데이터베이스의 저장된 프로시저에 대 한 매개 변수를 지정 하는 Function 요소의 자식입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-458">The **Parameter** element in store schema definition language (SSDL) is a child of the Function element that specifies parameters for a stored procedure in the database.</span></span>

<span data-ttu-id="0f7a1-459">합니다 **매개 변수** 요소 (나열 된 순서로)는 다음 자식 요소를 포함할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-459">The **Parameter** element can have the following child elements (in the order listed):</span></span>

-   <span data-ttu-id="0f7a1-460">설명서 (0 또는 1)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-460">Documentation (zero or one)</span></span>
-   <span data-ttu-id="0f7a1-461">Annotation 요소 (0 개 이상)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-461">Annotation elements (zero or more)</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="0f7a1-462">적용 가능한 특성</span><span class="sxs-lookup"><span data-stu-id="0f7a1-462">Applicable Attributes</span></span>

<span data-ttu-id="0f7a1-463">아래 표에서 설명에 적용할 수 있는 특성을 **매개 변수** 요소.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-463">The table below describes the attributes that can be applied to the **Parameter** element.</span></span>

| <span data-ttu-id="0f7a1-464">특성 이름</span><span class="sxs-lookup"><span data-stu-id="0f7a1-464">Attribute Name</span></span> | <span data-ttu-id="0f7a1-465">필수 여부</span><span class="sxs-lookup"><span data-stu-id="0f7a1-465">Is Required</span></span> | <span data-ttu-id="0f7a1-466">값</span><span class="sxs-lookup"><span data-stu-id="0f7a1-466">Value</span></span>                                                                                                                                                                                                                           |
|:---------------|:------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="0f7a1-467">**이름**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-467">**Name**</span></span>       | <span data-ttu-id="0f7a1-468">예</span><span class="sxs-lookup"><span data-stu-id="0f7a1-468">Yes</span></span>         | <span data-ttu-id="0f7a1-469">매개 변수의 이름입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-469">The name of the parameter.</span></span>                                                                                                                                                                                                      |
| <span data-ttu-id="0f7a1-470">**Type**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-470">**Type**</span></span>       | <span data-ttu-id="0f7a1-471">예</span><span class="sxs-lookup"><span data-stu-id="0f7a1-471">Yes</span></span>         | <span data-ttu-id="0f7a1-472">매개 변수 형식입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-472">The parameter type.</span></span>                                                                                                                                                                                                             |
| <span data-ttu-id="0f7a1-473">**모드**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-473">**Mode**</span></span>       | <span data-ttu-id="0f7a1-474">아니요</span><span class="sxs-lookup"><span data-stu-id="0f7a1-474">No</span></span>          | <span data-ttu-id="0f7a1-475">**In**, **초과**, 또는 **InOut** 매개 변수는 입력, 출력 또는 입출력 매개 변수 인지에 따라 합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-475">**In**, **Out**, or **InOut** depending on whether the parameter is an input, output, or input/output parameter.</span></span>                                                                                                                |
| <span data-ttu-id="0f7a1-476">**MaxLength**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-476">**MaxLength**</span></span>  | <span data-ttu-id="0f7a1-477">아니요</span><span class="sxs-lookup"><span data-stu-id="0f7a1-477">No</span></span>          | <span data-ttu-id="0f7a1-478">매개 변수의 최대 길이입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-478">The maximum length of the parameter.</span></span>                                                                                                                                                                                            |
| <span data-ttu-id="0f7a1-479">**전체 자릿수**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-479">**Precision**</span></span>  | <span data-ttu-id="0f7a1-480">아니요</span><span class="sxs-lookup"><span data-stu-id="0f7a1-480">No</span></span>          | <span data-ttu-id="0f7a1-481">매개 변수의 전체 자릿수입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-481">The precision of the parameter.</span></span>                                                                                                                                                                                                 |
| <span data-ttu-id="0f7a1-482">**배율**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-482">**Scale**</span></span>      | <span data-ttu-id="0f7a1-483">아니요</span><span class="sxs-lookup"><span data-stu-id="0f7a1-483">No</span></span>          | <span data-ttu-id="0f7a1-484">매개 변수의 소수 자릿수입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-484">The scale of the parameter.</span></span>                                                                                                                                                                                                     |
| <span data-ttu-id="0f7a1-485">**SRID**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-485">**SRID**</span></span>       | <span data-ttu-id="0f7a1-486">아니요</span><span class="sxs-lookup"><span data-stu-id="0f7a1-486">No</span></span>          | <span data-ttu-id="0f7a1-487">시스템 공간 참조 식별자입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-487">Spatial System Reference Identifier.</span></span> <span data-ttu-id="0f7a1-488">공간 형식 매개 변수에 유효 합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-488">Valid only for parameters of spatial types.</span></span> <span data-ttu-id="0f7a1-489">자세한 내용은 [SRID](http://en.wikipedia.org/wiki/SRID) 하 고 [SRID (SQL Server)](https://msdn.microsoft.com/library/bb964707.aspx)합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-489">For more information, see [SRID](http://en.wikipedia.org/wiki/SRID) and [SRID (SQL Server)](https://msdn.microsoft.com/library/bb964707.aspx).</span></span> |

> [!NOTE]
> <span data-ttu-id="0f7a1-490">주석 특성 (사용자 지정 XML 특성)을 개수에 관계 없이 적용할 수 있습니다 합니다 **매개 변수** 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-490">Any number of annotation attributes (custom XML attributes) may be applied to the **Parameter** element.</span></span> <span data-ttu-id="0f7a1-491">그러나 사용자 지정 특성은 SSDL에 예약된 XML 네임스페이스에 속할 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-491">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="0f7a1-492">두 사용자 지정 특성의 정규화된 이름은 서로 같을 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-492">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="0f7a1-493">예제</span><span class="sxs-lookup"><span data-stu-id="0f7a1-493">Example</span></span>

<span data-ttu-id="0f7a1-494">에서는 다음 예제는 **함수** 를 가진 두 요소가 **매개 변수** 입력된 매개 변수를 지정 하는 요소:</span><span class="sxs-lookup"><span data-stu-id="0f7a1-494">The following example shows a **Function** element that has two **Parameter** elements that specify input parameters:</span></span>
...
## <a name="principal-element-ssdl"></a><span data-ttu-id="0f7a1-495">Principal 요소(SSDL)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-495">Principal Element (SSDL)</span></span>

<span data-ttu-id="0f7a1-496">합니다 **주** 저장소 스키마 정의 언어 (SSDL)에 참조 제약 조건이 라고도 하는 외래 키 제약 조건의 주 끝을 정의 하는 ReferentialConstraint 요소에 자식 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-496">The **Principal** element in store schema definition language (SSDL) is a child element to the ReferentialConstraint element that defines the principal end of a foreign key constraint (also called a referential constraint).</span></span> <span data-ttu-id="0f7a1-497">합니다 **주** 다른 열 (또는 열)에서 참조 되는 테이블의 기본 키 열 (또는 열)를 지정 하는 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-497">The **Principal** element specifies the primary key column (or columns) in a table that is referenced by another column (or columns).</span></span> <span data-ttu-id="0f7a1-498">**PropertyRef** 요소 참조 되는 열을 지정 합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-498">**PropertyRef** elements specify which columns are referenced.</span></span> <span data-ttu-id="0f7a1-499">Dependent 요소에 지정 된 기본 키 열을 참조 하는 열을 지정 합니다 **주** 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-499">The Dependent element specifies columns that reference the primary key columns that are specified in the **Principal** element.</span></span>

<span data-ttu-id="0f7a1-500">합니다 **주** 요소 (나열 된 순서로)는 다음 자식 요소를 포함할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-500">The **Principal** element can have the following child elements (in the order listed):</span></span>

-   <span data-ttu-id="0f7a1-501">PropertyRef (하나 이상)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-501">PropertyRef (one or more)</span></span>
-   <span data-ttu-id="0f7a1-502">Annotation 요소 (0 개 이상)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-502">Annotation elements (zero or more)</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="0f7a1-503">적용 가능한 특성</span><span class="sxs-lookup"><span data-stu-id="0f7a1-503">Applicable Attributes</span></span>

<span data-ttu-id="0f7a1-504">다음 표에서 설명에 적용할 수 있는 특성을 **주** 요소.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-504">The following table describes the attributes that can be applied to the **Principal** element.</span></span>

| <span data-ttu-id="0f7a1-505">특성 이름</span><span class="sxs-lookup"><span data-stu-id="0f7a1-505">Attribute Name</span></span> | <span data-ttu-id="0f7a1-506">필수 여부</span><span class="sxs-lookup"><span data-stu-id="0f7a1-506">Is Required</span></span> | <span data-ttu-id="0f7a1-507">값</span><span class="sxs-lookup"><span data-stu-id="0f7a1-507">Value</span></span>                                                                                                                                                      |
|:---------------|:------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="0f7a1-508">**역할**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-508">**Role**</span></span>       | <span data-ttu-id="0f7a1-509">예</span><span class="sxs-lookup"><span data-stu-id="0f7a1-509">Yes</span></span>         | <span data-ttu-id="0f7a1-510">같은 값을 **역할** (사용) 하는 경우 해당 End 요소의 특성, 그렇지 않으면 테이블의 이름을 포함 하는 참조 된 열입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-510">The same value as the **Role** attribute (if used) of the corresponding End element; otherwise, the name of the table that contains the referenced column.</span></span> |

> [!NOTE]
> <span data-ttu-id="0f7a1-511">주석 특성 (사용자 지정 XML 특성)을 개수에 관계 없이 적용할 수 있습니다 합니다 **주** 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-511">Any number of annotation attributes (custom XML attributes) may be applied to the **Principal** element.</span></span> <span data-ttu-id="0f7a1-512">그러나 사용자 지정 특성은 CSDL에 예약된 XML 네임스페이스에 속할 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-512">However, custom attributes may not belong to any XML namespace that is reserved for CSDL.</span></span> <span data-ttu-id="0f7a1-513">두 사용자 지정 특성의 정규화된 이름은 서로 같을 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-513">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="0f7a1-514">예제</span><span class="sxs-lookup"><span data-stu-id="0f7a1-514">Example</span></span>

<span data-ttu-id="0f7a1-515">다음 예제에서는 사용 하는 연결 요소를 **ReferentialConstraint** 참여 하는 열을 지정 하는 요소는 **FK\_CustomerOrders** 외래 키 제약 조건입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-515">The following example shows an Association element that uses a **ReferentialConstraint** element to specify the columns that participate in the **FK\_CustomerOrders** foreign key constraint.</span></span> <span data-ttu-id="0f7a1-516">**주** 요소를 지정 합니다 **CustomerId** 열의 **고객** 테이블 제약 조건의 주 끝으로 합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-516">The **Principal** element specifies the **CustomerId** column of the **Customer** table as the principal end of the constraint.</span></span>
...
## <a name="property-element-ssdl"></a><span data-ttu-id="0f7a1-517">Property 요소(SSDL)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-517">Property Element (SSDL)</span></span>

<span data-ttu-id="0f7a1-518">합니다 **속성** 요소 (SSDL) 저장소 스키마 정의 언어에서 기본 데이터베이스의 테이블에 열을 나타냅니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-518">The **Property** element in store schema definition language (SSDL) represents a column in a table in the underlying database.</span></span> <span data-ttu-id="0f7a1-519">**속성** 요소가 테이블의 행을 나타내는 EntityType 요소의 자식입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-519">**Property** elements are children of EntityType elements, which represent rows in a table.</span></span> <span data-ttu-id="0f7a1-520">각 **속성** 에 정의 된 요소를 **EntityType** 요소는 열을 나타냅니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-520">Each **Property** element defined on an **EntityType** element represents a column.</span></span>

<span data-ttu-id="0f7a1-521">A **속성** 요소는 모든 자식 요소를 포함할 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-521">A **Property** element cannot have any child elements.</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="0f7a1-522">적용 가능한 특성</span><span class="sxs-lookup"><span data-stu-id="0f7a1-522">Applicable Attributes</span></span>

<span data-ttu-id="0f7a1-523">다음 표에서 설명에 적용할 수 있는 특성을 **속성** 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-523">The following table describes the attributes that can be applied to the **Property** element.</span></span>

| <span data-ttu-id="0f7a1-524">특성 이름</span><span class="sxs-lookup"><span data-stu-id="0f7a1-524">Attribute Name</span></span>            | <span data-ttu-id="0f7a1-525">필수 여부</span><span class="sxs-lookup"><span data-stu-id="0f7a1-525">Is Required</span></span> | <span data-ttu-id="0f7a1-526">값</span><span class="sxs-lookup"><span data-stu-id="0f7a1-526">Value</span></span>                                                                                                                                                                                                                           |
|:--------------------------|:------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="0f7a1-527">**이름**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-527">**Name**</span></span>                  | <span data-ttu-id="0f7a1-528">예</span><span class="sxs-lookup"><span data-stu-id="0f7a1-528">Yes</span></span>         | <span data-ttu-id="0f7a1-529">해당 열의 이름입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-529">The name of the corresponding column.</span></span>                                                                                                                                                                                           |
| <span data-ttu-id="0f7a1-530">**Type**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-530">**Type**</span></span>                  | <span data-ttu-id="0f7a1-531">예</span><span class="sxs-lookup"><span data-stu-id="0f7a1-531">Yes</span></span>         | <span data-ttu-id="0f7a1-532">해당 열의 형식입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-532">The type of the corresponding column.</span></span>                                                                                                                                                                                           |
| <span data-ttu-id="0f7a1-533">**Null 허용**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-533">**Nullable**</span></span>              | <span data-ttu-id="0f7a1-534">아니요</span><span class="sxs-lookup"><span data-stu-id="0f7a1-534">No</span></span>          | <span data-ttu-id="0f7a1-535">**True 이면** (기본값) 또는 **False** 해당 열에 null 값을 사용할 수 있는지 여부에 따라 합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-535">**True** (the default value) or **False** depending on whether the corresponding column can have a null value.</span></span>                                                                                                                  |
| <span data-ttu-id="0f7a1-536">**DefaultValue**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-536">**DefaultValue**</span></span>          | <span data-ttu-id="0f7a1-537">아니요</span><span class="sxs-lookup"><span data-stu-id="0f7a1-537">No</span></span>          | <span data-ttu-id="0f7a1-538">해당 열의 기본값입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-538">The default value of the corresponding column.</span></span>                                                                                                                                                                                  |
| <span data-ttu-id="0f7a1-539">**MaxLength**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-539">**MaxLength**</span></span>             | <span data-ttu-id="0f7a1-540">아니요</span><span class="sxs-lookup"><span data-stu-id="0f7a1-540">No</span></span>          | <span data-ttu-id="0f7a1-541">해당 열의 최대 길이입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-541">The maximum length of the corresponding column.</span></span>                                                                                                                                                                                 |
| <span data-ttu-id="0f7a1-542">**FixedLength**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-542">**FixedLength**</span></span>           | <span data-ttu-id="0f7a1-543">아니요</span><span class="sxs-lookup"><span data-stu-id="0f7a1-543">No</span></span>          | <span data-ttu-id="0f7a1-544">**True 이면** 나 **False** 고정된 길이 문자열로 해당 열 값이 저장될지 여부에 따라 합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-544">**True** or **False** depending on whether the corresponding column value will be stored as a fixed length string.</span></span>                                                                                                              |
| <span data-ttu-id="0f7a1-545">**전체 자릿수**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-545">**Precision**</span></span>             | <span data-ttu-id="0f7a1-546">아니요</span><span class="sxs-lookup"><span data-stu-id="0f7a1-546">No</span></span>          | <span data-ttu-id="0f7a1-547">해당 열의 전체 자릿수입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-547">The precision of the corresponding column.</span></span>                                                                                                                                                                                      |
| <span data-ttu-id="0f7a1-548">**배율**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-548">**Scale**</span></span>                 | <span data-ttu-id="0f7a1-549">아니요</span><span class="sxs-lookup"><span data-stu-id="0f7a1-549">No</span></span>          | <span data-ttu-id="0f7a1-550">해당 열의 소수 자릿수입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-550">The scale of the corresponding column.</span></span>                                                                                                                                                                                          |
| <span data-ttu-id="0f7a1-551">**유니코드**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-551">**Unicode**</span></span>               | <span data-ttu-id="0f7a1-552">아니요</span><span class="sxs-lookup"><span data-stu-id="0f7a1-552">No</span></span>          | <span data-ttu-id="0f7a1-553">**True 이면** 나 **False** 유니코드 문자열로 해당 열 값이 저장될지 여부에 따라 합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-553">**True** or **False** depending on whether the corresponding column value will be stored as a Unicode string.</span></span>                                                                                                                   |
| <span data-ttu-id="0f7a1-554">**데이터 정렬**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-554">**Collation**</span></span>             | <span data-ttu-id="0f7a1-555">아니요</span><span class="sxs-lookup"><span data-stu-id="0f7a1-555">No</span></span>          | <span data-ttu-id="0f7a1-556">데이터 소스에 사용될 데이터 정렬 순서를 지정하는 문자열입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-556">A string that specifies the collating sequence to be used in the data source.</span></span>                                                                                                                                                   |
| <span data-ttu-id="0f7a1-557">**SRID**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-557">**SRID**</span></span>                  | <span data-ttu-id="0f7a1-558">아니요</span><span class="sxs-lookup"><span data-stu-id="0f7a1-558">No</span></span>          | <span data-ttu-id="0f7a1-559">시스템 공간 참조 식별자입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-559">Spatial System Reference Identifier.</span></span> <span data-ttu-id="0f7a1-560">공간 형식의 속성에 대해서만 유효 합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-560">Valid only for properties of spatial types.</span></span> <span data-ttu-id="0f7a1-561">자세한 내용은 [SRID](http://en.wikipedia.org/wiki/SRID) 하 고 [SRID (SQL Server)](https://msdn.microsoft.com/library/bb964707.aspx)합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-561">For more information, see [SRID](http://en.wikipedia.org/wiki/SRID) and [SRID (SQL Server)](https://msdn.microsoft.com/library/bb964707.aspx).</span></span> |
| <span data-ttu-id="0f7a1-562">**StoreGeneratedPattern**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-562">**StoreGeneratedPattern**</span></span> | <span data-ttu-id="0f7a1-563">아니요</span><span class="sxs-lookup"><span data-stu-id="0f7a1-563">No</span></span>          | <span data-ttu-id="0f7a1-564">**None**, **Identity** (하는 경우 해당 열 값이 데이터베이스에서 생성 된 id), 또는 **계산 됨** (하는 경우 해당 열 값은 데이터베이스에서 계산).</span><span class="sxs-lookup"><span data-stu-id="0f7a1-564">**None**, **Identity** (if the corresponding column value is an identity that is generated in the database), or **Computed** (if the corresponding column value is computed in the database).</span></span> <span data-ttu-id="0f7a1-565">RowType 속성에 대해 유효 하지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-565">Not Valid for RowType properties.</span></span> |

> [!NOTE]
> <span data-ttu-id="0f7a1-566">주석 특성 (사용자 지정 XML 특성)을 개수에 관계 없이 적용할 수 있습니다 합니다 **속성** 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-566">Any number of annotation attributes (custom XML attributes) may be applied to the **Property** element.</span></span> <span data-ttu-id="0f7a1-567">그러나 사용자 지정 특성은 SSDL에 예약된 XML 네임스페이스에 속할 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-567">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="0f7a1-568">두 사용자 지정 특성의 정규화된 이름은 서로 같을 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-568">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="0f7a1-569">예제</span><span class="sxs-lookup"><span data-stu-id="0f7a1-569">Example</span></span>

<span data-ttu-id="0f7a1-570">다음 예제는 **EntityType** 두 개의 자식 **속성** 요소:</span><span class="sxs-lookup"><span data-stu-id="0f7a1-570">The following example shows an **EntityType** element with two child **Property** elements:</span></span>
...
## <a name="propertyref-element-ssdl"></a><span data-ttu-id="0f7a1-571">PropertyRef 요소(SSDL)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-571">PropertyRef Element (SSDL)</span></span>

<span data-ttu-id="0f7a1-572">합니다 **PropertyRef** 요소 (SSDL) 저장소 스키마 정의 언어에서를 나타내는 속성이 다음 역할 중 하나가 수행 되는 EntityType 요소에 정의 된 속성을 참조 합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-572">The **PropertyRef** element in store schema definition language (SSDL) references a property defined on an EntityType element to indicate that the property will perform one of the following roles:</span></span>

-   <span data-ttu-id="0f7a1-573">테이블의 기본 키의 일부 여야 하는 **EntityType** 나타냅니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-573">Be part of the primary key of the table that the **EntityType** represents.</span></span> <span data-ttu-id="0f7a1-574">하나 이상의 **PropertyRef** 기본 키를 정의 하는 요소를 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-574">One or more **PropertyRef** elements can be used to define a primary key.</span></span> <span data-ttu-id="0f7a1-575">자세한 내용은 키 요소를 참조 하세요.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-575">For more information, see Key element.</span></span>
-   <span data-ttu-id="0f7a1-576">참조 제약 조건의 종속 또는 주 끝.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-576">Be the dependent or principal end of a referential constraint.</span></span> <span data-ttu-id="0f7a1-577">자세한 내용은 ReferentialConstraint 요소를 참조 하세요.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-577">For more information, see ReferentialConstraint element.</span></span>

<span data-ttu-id="0f7a1-578">합니다 **PropertyRef** 요소는 다음과 같은 자식 요소를 하나만 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-578">The **PropertyRef** element can only have the following child elements:</span></span>

-   <span data-ttu-id="0f7a1-579">설명서 (0 또는 1)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-579">Documentation (zero or one)</span></span>
-   <span data-ttu-id="0f7a1-580">Annotation 요소</span><span class="sxs-lookup"><span data-stu-id="0f7a1-580">Annotation elements</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="0f7a1-581">적용 가능한 특성</span><span class="sxs-lookup"><span data-stu-id="0f7a1-581">Applicable Attributes</span></span>

<span data-ttu-id="0f7a1-582">아래 표에서 설명에 적용할 수 있는 특성을 **PropertyRef** 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-582">The table below describes the attributes that can be applied to the **PropertyRef** element.</span></span>

| <span data-ttu-id="0f7a1-583">특성 이름</span><span class="sxs-lookup"><span data-stu-id="0f7a1-583">Attribute Name</span></span> | <span data-ttu-id="0f7a1-584">필수 여부</span><span class="sxs-lookup"><span data-stu-id="0f7a1-584">Is Required</span></span> | <span data-ttu-id="0f7a1-585">값</span><span class="sxs-lookup"><span data-stu-id="0f7a1-585">Value</span></span>                                |
|:---------------|:------------|:-------------------------------------|
| <span data-ttu-id="0f7a1-586">**이름**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-586">**Name**</span></span>       | <span data-ttu-id="0f7a1-587">예</span><span class="sxs-lookup"><span data-stu-id="0f7a1-587">Yes</span></span>         | <span data-ttu-id="0f7a1-588">참조된 속성의 이름입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-588">The name of the referenced property.</span></span> |

> [!NOTE]
> <span data-ttu-id="0f7a1-589">주석 특성 (사용자 지정 XML 특성)을 개수에 관계 없이 적용할 수 있습니다 합니다 **PropertyRef** 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-589">Any number of annotation attributes (custom XML attributes) may be applied to the **PropertyRef** element.</span></span> <span data-ttu-id="0f7a1-590">그러나 사용자 지정 특성은 CSDL에 예약된 XML 네임스페이스에 속할 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-590">However, custom attributes may not belong to any XML namespace that is reserved for CSDL.</span></span> <span data-ttu-id="0f7a1-591">두 사용자 지정 특성의 정규화된 이름은 서로 같을 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-591">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="0f7a1-592">예제</span><span class="sxs-lookup"><span data-stu-id="0f7a1-592">Example</span></span>

<span data-ttu-id="0f7a1-593">에서는 다음 예제는 **PropertyRef** 에 정의 된 속성을 참조 하 여 기본 키를 정의 하는 데 사용 되는 요소는 **EntityType** 요소.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-593">The following example shows a **PropertyRef** element used to define a primary key by referencing a property that is defined on an **EntityType** element.</span></span>
...
## <a name="referentialconstraint-element-ssdl"></a><span data-ttu-id="0f7a1-594">ReferentialConstraint 요소(SSDL)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-594">ReferentialConstraint Element (SSDL)</span></span>

<span data-ttu-id="0f7a1-595">합니다 **ReferentialConstraint** 요소 (SSDL) 저장소 스키마 정의 언어에 기본 데이터베이스에는 참조 무결성 제약 조건이 라고도 하는 외래 키 제약을 나타냅니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-595">The **ReferentialConstraint** element in store schema definition language (SSDL) represents a foreign key constraint (also called a referential integrity constraint) in the underlying database.</span></span> <span data-ttu-id="0f7a1-596">제약 조건의 주 끝 및 종속 끝 각각 보안 주체 및 종속 자식 요소에 의해 지정 됩니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-596">The principal and dependent ends of the constraint are specified by the Principal and Dependent child elements, respectively.</span></span> <span data-ttu-id="0f7a1-597">주 끝과 종속 끝에 참여 하는 열은 PropertyRef 요소를 사용 하 여 참조 됩니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-597">Columns that participate in the principal and dependent ends are referenced with PropertyRef elements.</span></span>

<span data-ttu-id="0f7a1-598">합니다 **ReferentialConstraint** 요소는 Association 요소의 선택적 자식 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-598">The **ReferentialConstraint** element is an optional child element of the Association element.</span></span> <span data-ttu-id="0f7a1-599">경우는 **ReferentialConstraint** 요소에 지정 된 외래 키 제약 조건에 매핑할 사용 하지 않으면 합니다 **연결** 이 작업을 수행 하려면 요소를 사용 해야 하는 AssociationSetMapping 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-599">If a **ReferentialConstraint** element is not used to map the foreign key constraint that is specified in the **Association** element, an AssociationSetMapping element must be used to do this.</span></span>

<span data-ttu-id="0f7a1-600">합니다 **ReferentialConstraint** 요소는 다음 자식 요소를 포함할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-600">The **ReferentialConstraint** element can have the following child elements:</span></span>

-   <span data-ttu-id="0f7a1-601">설명서 (0 또는 1)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-601">Documentation (zero or one)</span></span>
-   <span data-ttu-id="0f7a1-602">보안 주체 (1 개만)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-602">Principal (exactly one)</span></span>
-   <span data-ttu-id="0f7a1-603">종속 (1 개만)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-603">Dependent (exactly one)</span></span>
-   <span data-ttu-id="0f7a1-604">Annotation 요소 (0 개 이상)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-604">Annotation elements (zero or more)</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="0f7a1-605">적용 가능한 특성</span><span class="sxs-lookup"><span data-stu-id="0f7a1-605">Applicable Attributes</span></span>

<span data-ttu-id="0f7a1-606">주석 특성 (사용자 지정 XML 특성)을 개수에 관계 없이 적용할 수 있습니다 합니다 **ReferentialConstraint** 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-606">Any number of annotation attributes (custom XML attributes) may be applied to the **ReferentialConstraint** element.</span></span> <span data-ttu-id="0f7a1-607">그러나 사용자 지정 특성은 SSDL에 예약된 XML 네임스페이스에 속할 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-607">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="0f7a1-608">두 사용자 지정 특성의 정규화된 이름은 서로 같을 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-608">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="0f7a1-609">예제</span><span class="sxs-lookup"><span data-stu-id="0f7a1-609">Example</span></span>

<span data-ttu-id="0f7a1-610">다음 예제와 **연결** 사용 하는 요소를 **ReferentialConstraint** 참여 하는 열을 지정 하는 요소는 **FK\_CustomerOrders**  foreign key 제약 조건:</span><span class="sxs-lookup"><span data-stu-id="0f7a1-610">The following example shows an **Association** element that uses a **ReferentialConstraint** element to specify the columns that participate in the **FK\_CustomerOrders** foreign key constraint:</span></span>
...
## <a name="returntype-element-ssdl"></a><span data-ttu-id="0f7a1-611">ReturnType 요소 (SSDL)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-611">ReturnType Element (SSDL)</span></span>

<span data-ttu-id="0f7a1-612">합니다 **ReturnType** (SSDL) 저장소 스키마 정의 언어에서 요소에 정의 된 함수에 대 한 반환 형식을 지정 하는 **함수** 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-612">The **ReturnType** element in store schema definition language (SSDL) specifies the return type for a function that is defined in a **Function** element.</span></span> <span data-ttu-id="0f7a1-613">함수 반환 형식으로 지정할 수도 있습니다는 **ReturnType** 특성입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-613">A function return type can also be specified with a **ReturnType** attribute.</span></span>

<span data-ttu-id="0f7a1-614">함수의 반환 형식이 지정 된 된 **형식** 특성 또는 **ReturnType** 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-614">The return type of a function is specified with the **Type** attribute or the **ReturnType** element.</span></span>

<span data-ttu-id="0f7a1-615">합니다 **ReturnType** 요소는 다음 자식 요소를 포함할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-615">The **ReturnType** element can have the following child elements:</span></span>

- <span data-ttu-id="0f7a1-616">CollectionType (1 개)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-616">CollectionType (one)</span></span>  

> [!NOTE]
> <span data-ttu-id="0f7a1-617">주석 특성 (사용자 지정 XML 특성)을 개수에 관계 없이 적용할 수 있습니다 합니다 **ReturnType** 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-617">Any number of annotation attributes (custom XML attributes) may be applied to the **ReturnType** element.</span></span> <span data-ttu-id="0f7a1-618">그러나 사용자 지정 특성은 SSDL에 예약된 XML 네임스페이스에 속할 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-618">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="0f7a1-619">두 사용자 지정 특성의 정규화된 이름은 서로 같을 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-619">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="0f7a1-620">예제</span><span class="sxs-lookup"><span data-stu-id="0f7a1-620">Example</span></span>

<span data-ttu-id="0f7a1-621">다음 예에서는 **함수** 는 행의 컬렉션을 반환 합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-621">The following example uses a **Function** that returns a collection of rows.</span></span>
...
## <a name="rowtype-element-ssdl"></a><span data-ttu-id="0f7a1-622">RowType 요소 (SSDL)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-622">RowType Element (SSDL)</span></span>

<span data-ttu-id="0f7a1-623">A **RowType** 반환는 명명 되지 않은 구조를 정의 하는 저장소 스키마 정의 언어 (SSDL)의 요소 형식 저장소에 정의 된 함수에 대 한 합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-623">A **RowType** element in store schema definition language (SSDL) defines an unnamed structure as a return type for a function defined in the store.</span></span>

<span data-ttu-id="0f7a1-624">A **RowType** 요소는 자식 요소입니다 **CollectionType** 요소:</span><span class="sxs-lookup"><span data-stu-id="0f7a1-624">A **RowType** element is the child element of **CollectionType** element:</span></span>

<span data-ttu-id="0f7a1-625">A **RowType** 요소는 다음 자식 요소를 포함할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-625">A **RowType** element can have the following child elements:</span></span>

- <span data-ttu-id="0f7a1-626">속성 (하나 이상)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-626">Property (one or more)</span></span>  

### <a name="example"></a><span data-ttu-id="0f7a1-627">예제</span><span class="sxs-lookup"><span data-stu-id="0f7a1-627">Example</span></span>

<span data-ttu-id="0f7a1-628">다음 예제에서는 사용 하는 저장소 함수를 **CollectionType** 는 반환 행 컬렉션을 지정 하는 요소 (에 지정 된 대로 합니다 **RowType** 요소).</span><span class="sxs-lookup"><span data-stu-id="0f7a1-628">The following example shows a store function that uses a **CollectionType** element to specify that the function returns a collection of rows (as specified in the **RowType** element).</span></span>
...
## <a name="schema-element-ssdl"></a><span data-ttu-id="0f7a1-629">스키마 요소(SSDL)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-629">Schema Element (SSDL)</span></span>

<span data-ttu-id="0f7a1-630">합니다 **스키마** (SSDL) 저장소 스키마 정의 언어에서 요소는 저장소 모델 정의의 루트 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-630">The **Schema** element in store schema definition language (SSDL) is the root element of a storage model definition.</span></span> <span data-ttu-id="0f7a1-631">이 요소에는 스토리지 모델을 구성하는 개체, 함수 및 컨테이너에 대한 정의가 포함되어 있습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-631">It contains definitions for the objects, functions, and containers that make up a storage model.</span></span>

<span data-ttu-id="0f7a1-632">합니다 **스키마** 요소 0 개 이상의 자식 요소를 포함할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-632">The **Schema** element may contain zero or more of the following child elements:</span></span>

-   <span data-ttu-id="0f7a1-633">형식 연결</span><span class="sxs-lookup"><span data-stu-id="0f7a1-633">Association</span></span>
-   <span data-ttu-id="0f7a1-634">EntityType</span><span class="sxs-lookup"><span data-stu-id="0f7a1-634">EntityType</span></span>
-   <span data-ttu-id="0f7a1-635">EntityContainer</span><span class="sxs-lookup"><span data-stu-id="0f7a1-635">EntityContainer</span></span>
-   <span data-ttu-id="0f7a1-636">기능</span><span class="sxs-lookup"><span data-stu-id="0f7a1-636">Function</span></span>

<span data-ttu-id="0f7a1-637">합니다 **스키마** 요소를 사용 합니다 **Namespace** 저장소 모델의 엔터티 형식 및 연결 개체에 대 한 네임 스페이스를 정의 하는 특성입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-637">The **Schema** element uses the **Namespace** attribute to define the namespace for the entity type and association objects in a storage model.</span></span> <span data-ttu-id="0f7a1-638">네임스페이스 내에서 두 개체의 이름이 서로 같을 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-638">Within a namespace, no two objects can have the same name.</span></span>

<span data-ttu-id="0f7a1-639">저장소 모델 네임 스페이스의 XML 네임 스페이스와에서 다릅니다. 합니다 **스키마** 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-639">A storage model namespace is different from the XML namespace of the **Schema** element.</span></span> <span data-ttu-id="0f7a1-640">저장소 모델 네임 스페이스 (정의 된 대로 합니다 **Namespace** 특성)은 엔터티 형식 및 연결 형식에 대 한 논리적 컨테이너입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-640">A storage model namespace (as defined by the **Namespace** attribute) is a logical container for entity types and association types.</span></span> <span data-ttu-id="0f7a1-641">XML 네임 스페이스 (나타난 합니다 **xmlns** 특성)의 **스키마** 요소는 자식 요소 및 특성에 대 한 기본 네임 스페이스를 **스키마** 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-641">The XML namespace (indicated by the **xmlns** attribute) of a **Schema** element is the default namespace for child elements and attributes of the **Schema** element.</span></span> <span data-ttu-id="0f7a1-642">폼의 XML 네임 스페이스 http://schemas.microsoft.com/ado/YYYY/MM/edm/ssdl (여기서 YYYY, MM은 연도 및 월 각각)는 SSDL 용으로 예약 되어 있습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-642">XML namespaces of the form http://schemas.microsoft.com/ado/YYYY/MM/edm/ssdl (where YYYY and MM represent a year and month respectively) are reserved for SSDL.</span></span> <span data-ttu-id="0f7a1-643">사용자 지정 요소 및 특성은 이러한 형식의 네임스페이스에 있을 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-643">Custom elements and attributes cannot be in namespaces that have this form.</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="0f7a1-644">적용 가능한 특성</span><span class="sxs-lookup"><span data-stu-id="0f7a1-644">Applicable Attributes</span></span>

<span data-ttu-id="0f7a1-645">아래 표에서 특성을 설명에 적용할 수는 **스키마** 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-645">The table below describes the attributes can be applied to the **Schema** element.</span></span>

| <span data-ttu-id="0f7a1-646">특성 이름</span><span class="sxs-lookup"><span data-stu-id="0f7a1-646">Attribute Name</span></span>            | <span data-ttu-id="0f7a1-647">필수 여부</span><span class="sxs-lookup"><span data-stu-id="0f7a1-647">Is Required</span></span> | <span data-ttu-id="0f7a1-648">값</span><span class="sxs-lookup"><span data-stu-id="0f7a1-648">Value</span></span>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|:--------------------------|:------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="0f7a1-649">**네임스페이스**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-649">**Namespace**</span></span>             | <span data-ttu-id="0f7a1-650">예</span><span class="sxs-lookup"><span data-stu-id="0f7a1-650">Yes</span></span>         | <span data-ttu-id="0f7a1-651">스토리지 모델의 네임스페이스입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-651">The namespace of the storage model.</span></span> <span data-ttu-id="0f7a1-652">값을 **Namespace** 특성 형식의 정규화 된 이름을 만드는 데 사용 됩니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-652">The value of the **Namespace** attribute is used to form the fully qualified name of a type.</span></span> <span data-ttu-id="0f7a1-653">예를 들어 경우는 **EntityType** 라는 *고객* ExampleModel.Store 네임 스페이스의 정규화 된 이름을를 **EntityType** 는 ExampleModel.Store.Customer입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-653">For example, if an **EntityType** named *Customer* is in the ExampleModel.Store namespace, then the fully qualified name of the **EntityType** is ExampleModel.Store.Customer.</span></span> <br/> <span data-ttu-id="0f7a1-654">다음 문자열 값으로 사용할 수 없습니다는 **Namespace** 특성: **System**를 **일시적인**, 또는 **Edm**합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-654">The following strings cannot be used as the value for the **Namespace** attribute: **System**, **Transient**, or **Edm**.</span></span> <span data-ttu-id="0f7a1-655">값을 **Namespace** 특성에 대 한 값과 같을 수 없습니다는 **Namespace** CSDL 스키마 요소의 특성입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-655">The value for the **Namespace** attribute cannot be the same as the value for the **Namespace** attribute in the CSDL Schema element.</span></span> |
| <span data-ttu-id="0f7a1-656">**Alias**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-656">**Alias**</span></span>                 | <span data-ttu-id="0f7a1-657">아니요</span><span class="sxs-lookup"><span data-stu-id="0f7a1-657">No</span></span>          | <span data-ttu-id="0f7a1-658">네임스페이스 이름 대신 사용되는 식별자입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-658">An identifier used in place of the namespace name.</span></span> <span data-ttu-id="0f7a1-659">예를 들어 경우는 **EntityType** 라는 *고객* ExampleModel.Store 네임 스페이스 및 값에는 **별칭** 특성이 *StorageModel*, StorageModel.Customer를 사용 하 여 정규화 된 이름으로는 **EntityType입니다.**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-659">For example, if an **EntityType** named *Customer* is in the ExampleModel.Store namespace and the value of the **Alias** attribute is *StorageModel*, then you can use StorageModel.Customer as the fully qualified name of the **EntityType.**</span></span>                                                                                                                                                                                                                                                                                    |
| <span data-ttu-id="0f7a1-660">**공급자**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-660">**Provider**</span></span>              | <span data-ttu-id="0f7a1-661">예</span><span class="sxs-lookup"><span data-stu-id="0f7a1-661">Yes</span></span>         | <span data-ttu-id="0f7a1-662">데이터 공급자입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-662">The data provider.</span></span>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| <span data-ttu-id="0f7a1-663">**ProviderManifestToken**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-663">**ProviderManifestToken**</span></span> | <span data-ttu-id="0f7a1-664">예</span><span class="sxs-lookup"><span data-stu-id="0f7a1-664">Yes</span></span>         | <span data-ttu-id="0f7a1-665">반환할 공급자 매니페스트를 공급자에게 나타내는 토큰입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-665">A token that indicates to the provider which provider manifest to return.</span></span> <span data-ttu-id="0f7a1-666">정의된 토큰의 형식은 없으며</span><span class="sxs-lookup"><span data-stu-id="0f7a1-666">No format for the token is defined.</span></span> <span data-ttu-id="0f7a1-667">토큰의 값은 공급자가 정의합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-667">Values for the token are defined by the provider.</span></span> <span data-ttu-id="0f7a1-668">SQL Server 공급자 매니페스트 토큰에 대 한 자세한 내용은 Entity Framework 용 SqlClient를 참조 하세요.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-668">For information about SQL Server provider manifest tokens, see SqlClient for Entity Framework.</span></span>                                                                                                                                                                                                                                                                                                                        |

### <a name="example"></a><span data-ttu-id="0f7a1-669">예제</span><span class="sxs-lookup"><span data-stu-id="0f7a1-669">Example</span></span>

<span data-ttu-id="0f7a1-670">다음 예제와 **스키마** 포함 하는 요소는 **EntityContainer** 요소, 두 **EntityType** 요소와 **연결** 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-670">The following example shows a **Schema** element that contains an **EntityContainer** element, two **EntityType** elements, and one **Association** element.</span></span>
...
## <a name="annotation-attributes"></a><span data-ttu-id="0f7a1-671">주석 특성</span><span class="sxs-lookup"><span data-stu-id="0f7a1-671">Annotation Attributes</span></span>

<span data-ttu-id="0f7a1-672">SSDL(스토리지 스키마 정의 언어)의 주석 특성은 스토리지 모델의 요소에 대한 추가 메타데이터를 제공하는 스토리지 모델의 사용자 지정 XML 특성입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-672">Annotation attributes in store schema definition language (SSDL) are custom XML attributes in the storage model that provide extra metadata about the elements in the storage model.</span></span> <span data-ttu-id="0f7a1-673">주석 특성은 올바른 XML 구조를 가져야 할 뿐 아니라 다음 제약 조건을 충족해야 합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-673">In addition to having valid XML structure, the following constraints apply to annotation attributes:</span></span>

-   <span data-ttu-id="0f7a1-674">주석 특성은 SSDL용으로 예약된 XML 네임스페이스에 속하지 않아야 합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-674">Annotation attributes must not be in any XML namespace that is reserved for SSDL.</span></span>
-   <span data-ttu-id="0f7a1-675">두 주석 특성의 정규화된 이름은 서로 같을 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-675">The fully-qualified names of any two annotation attributes must not be the same.</span></span>

<span data-ttu-id="0f7a1-676">두 개 이상의 주석 특성을 지정된 SSDL 요소에 적용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-676">More than one annotation attribute may be applied to a given SSDL element.</span></span> <span data-ttu-id="0f7a1-677">Annotation 요소에 포함 된 메타 데이터 System.Data.Metadata.Edm 네임 스페이스의 클래스를 사용 하 여 런타임에 액세스할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-677">Metadata contained in annotation elements can be accessed at runtime by using classes in the System.Data.Metadata.Edm namespace.</span></span>

### <a name="example"></a><span data-ttu-id="0f7a1-678">예제</span><span class="sxs-lookup"><span data-stu-id="0f7a1-678">Example</span></span>

<span data-ttu-id="0f7a1-679">다음 예제에서는 주석 특성이 적용 하는 EntityType 요소는 **OrderId** 속성입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-679">The following example shows an EntityType element that has an annotation attribute applied to the **OrderId** property.</span></span> <span data-ttu-id="0f7a1-680">예제도 추가 되는 주석 요소를 표시 합니다 **EntityType** 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-680">The example also show an annotation element added to the **EntityType** element.</span></span>
...
## <a name="annotation-elements-ssdl"></a><span data-ttu-id="0f7a1-681">Annotation 요소(SSDL)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-681">Annotation Elements (SSDL)</span></span>

<span data-ttu-id="0f7a1-682">SSDL(스토리지 스키마 정의 언어)의 Annotation 요소는 스토리지 모델에서 스토리지 모델에 대한 추가 메타데이터를 제공하는 사용자 지정 XML 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-682">Annotation elements in store schema definition language (SSDL) are custom XML elements in the storage model that provide extra metadata about the storage model.</span></span> <span data-ttu-id="0f7a1-683">Annotation 요소는 올바른 XML 구조를 가져야 함은 물론 다음 제약 조건이 적용됩니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-683">In addition to having valid XML structure, the following constraints apply to annotation elements:</span></span>

-   <span data-ttu-id="0f7a1-684">Annotation 요소는 SSDL용으로 예약된 XML 네임스페이스에 속하지 않아야 합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-684">Annotation elements must not be in any XML namespace that is reserved for SSDL.</span></span>
-   <span data-ttu-id="0f7a1-685">두 Annotation 요소의 정규화된 이름은 서로 같을 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-685">The fully-qualified names of any two annotation elements must not be the same.</span></span>
-   <span data-ttu-id="0f7a1-686">Annotation 요소는 제공된 SSDL 요소의 다른 모든 자식 요소 뒤에 나타나야 합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-686">Annotation elements must appear after all other child elements of a given SSDL element.</span></span>

<span data-ttu-id="0f7a1-687">두 개 이상의 Annotation 요소가 제공된 SSDL 요소의 자식이 될 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-687">More than one annotation element may be a child of a given SSDL element.</span></span> <span data-ttu-id="0f7a1-688">.NET Framework 버전 4부터 annotation 요소에 포함 된 메타 데이터에 액세스할 수 있습니다 런타임 System.Data.Metadata.Edm 네임 스페이스의 클래스를 사용 하 여 합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-688">Starting with the .NET Framework version 4, metadata contained in annotation elements can be accessed at runtime by using classes in the System.Data.Metadata.Edm namespace.</span></span>

### <a name="example"></a><span data-ttu-id="0f7a1-689">예제</span><span class="sxs-lookup"><span data-stu-id="0f7a1-689">Example</span></span>

<span data-ttu-id="0f7a1-690">다음 예제에서는 주석 요소에는 EntityType 요소를 보여 줍니다 (**CustomElement**).</span><span class="sxs-lookup"><span data-stu-id="0f7a1-690">The following example shows an EntityType element that has an annotation element (**CustomElement**).</span></span> <span data-ttu-id="0f7a1-691">또한이 예제에서는 주석 특성을 적용 합니다 **OrderId** 속성입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-691">The example also shows an annotation attribute applied to the **OrderId** property.</span></span>
...
## <a name="facets-ssdl"></a><span data-ttu-id="0f7a1-692">패싯(SSDL)</span><span class="sxs-lookup"><span data-stu-id="0f7a1-692">Facets (SSDL)</span></span>

<span data-ttu-id="0f7a1-693">저장소 스키마 정의 언어 (SSDL)의 패싯은 속성 요소에 지정 된 열 형식에 제약 조건을 나타냅니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-693">Facets in store schema definition language (SSDL) represent constraints on column types that are specified in Property elements.</span></span> <span data-ttu-id="0f7a1-694">패싯의 XML 특성으로 구현 됩니다 **속성** 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-694">Facets are implemented as XML attributes on **Property** elements.</span></span>

<span data-ttu-id="0f7a1-695">다음 표에서는 SSDL에서 지원되는 패싯에 대해 설명합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-695">The following table describes the facets that are supported in SSDL:</span></span>

| <span data-ttu-id="0f7a1-696">패싯</span><span class="sxs-lookup"><span data-stu-id="0f7a1-696">Facet</span></span>           | <span data-ttu-id="0f7a1-697">설명</span><span class="sxs-lookup"><span data-stu-id="0f7a1-697">Description</span></span>                                                                                                                                                                                                                                                 |
|:----------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="0f7a1-698">**데이터 정렬**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-698">**Collation**</span></span>   | <span data-ttu-id="0f7a1-699">속성 값에 대한 비교 및 순서 지정 작업을 수행할 때 사용할 데이터 정렬 순서 또는 정렬 순서를 지정합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-699">Specifies the collating sequence (or sorting sequence) to be used when performing comparison and ordering operations on values of the property.</span></span>                                                                                                             |
| <span data-ttu-id="0f7a1-700">**FixedLength**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-700">**FixedLength**</span></span> | <span data-ttu-id="0f7a1-701">열 값 길이가 다양할 수 있는지 여부를 지정합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-701">Specifies whether the length of the column value can vary.</span></span>                                                                                                                                                                                                  |
| <span data-ttu-id="0f7a1-702">**MaxLength**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-702">**MaxLength**</span></span>   | <span data-ttu-id="0f7a1-703">열 값의 최대 길이를 지정합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-703">Specifies the maximum length of the column value.</span></span>                                                                                                                                                                                                           |
| <span data-ttu-id="0f7a1-704">**전체 자릿수**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-704">**Precision**</span></span>   | <span data-ttu-id="0f7a1-705">형식의 속성에 대 한 **10 진수**, 속성 값을 가질 수 있습니다 자릿수를 지정 합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-705">For properties of type **Decimal**, specifies the number of digits a property value can have.</span></span> <span data-ttu-id="0f7a1-706">형식의 속성에 대 한 **시간**를 **DateTime**, 및 **DateTimeOffset**, 열 값의 초의 소수 부분 자릿수를 지정 합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-706">For properties of type **Time**, **DateTime**, and **DateTimeOffset**, specifies the number of digits for the fractional part of seconds of the column value.</span></span> |
| <span data-ttu-id="0f7a1-707">**배율**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-707">**Scale**</span></span>       | <span data-ttu-id="0f7a1-708">열 값에 대한 소수점 오른쪽의 자릿수를 지정합니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-708">Specifies the number of digits to the right of the decimal point for the column value.</span></span>                                                                                                                                                                      |
| <span data-ttu-id="0f7a1-709">**유니코드**</span><span class="sxs-lookup"><span data-stu-id="0f7a1-709">**Unicode**</span></span>     | <span data-ttu-id="0f7a1-710">열 값을 유니코드로 저장할지 여부를 나타냅니다.</span><span class="sxs-lookup"><span data-stu-id="0f7a1-710">Indicates whether the column value is stored as Unicode.</span></span>                                                                                                                                                                                                    |
