...
| 특성 이름 | 필수 여부 | 값                                                                     |
|:---------------|:------------|:--------------------------------------------------------------------------|
| **키**        | 예         | **Value** 특성에 지정 된 네임 스페이스에 대 한 별칭입니다. |
...
| **대상**             | 예         | 매핑되는 연결에 해당 하는 탐색 속성의 **Torole** 특성 값입니다. 자세한 내용은 NavigationProperty 요소 (CSDL)를 참조 하세요.   |
...
| 특성 이름     | 필수 여부 | 값                                                                                       |
|:-------------------|:------------|:--------------------------------------------------------------------------------------------|
| **Name**           | 예         | 매핑되는 개념적 모델 연결 집합의 이름                      |
| **T**       | 아니요          | 매핑되는 개념적 모델 연결 형식의 네임스페이스로 한정된 이름 |
...
| 특성 이름 | 필수 여부 | 값                                                                                            |
|:---------------|:------------|:-------------------------------------------------------------------------------------------------|
| **Name**       | 예         | 개념적 모델에서 매핑되는 엔터티 형식의 복합 속성 이름입니다. |
| **T**   | 아니요          | 개념적 모델 속성 형식의 네임스페이스로 한정된 이름입니다.                              |
...
| 특성 이름 | 필수 여부 | 값                                                                  |
|:---------------|:------------|:-----------------------------------------------------------------------|
| **T**   | 예         | 매핑되는 복합 형식의 네임스페이스로 한정된 이름입니다. |
...
| **Name**       | 아니요          | 조건을 확인하는 데 사용되는 값이 있는 개념적 모델 엔터티 속성의 이름입니다. <br/> **Condition** 요소가 FunctionImportMapping 요소 내에서 사용 되는 경우에는이 특성을 적용할 수 없습니다.                                                                           |
...
| 특성 이름           | 필수 여부 | 값                                                                                                                                                                                                                         |
|:-------------------------|:------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Name**                 | 예         | 매핑되는 개념적 모델 엔터티 집합의 이름입니다.                                                                                                                                                             |
...
| 특성 이름 | 필수 여부 | 값                                                                                                                                                                                                |
|:---------------|:------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **T**   | 예         | 매핑되는 개념적 모델 엔터티 형식의 네임스페이스로 한정된 이름입니다. <br/> 해당 형식이 추상 또는 파생 형식이면 이 값은 `IsOfType(Namespace-qualified_type_name)`이어야 합니다. |
...
| 특성 이름 | 필수 여부 | 값                                                                         |
|:---------------|:------------|:------------------------------------------------------------------------------|
| **T**   | 아니요          | 쿼리 뷰에 의해 매핑되는 개념적 모델 형식의 이름입니다. |
...
| 특성 이름 | 필수 여부 | 값                                                                         |
|:---------------|:------------|:------------------------------------------------------------------------------|
| **Name**       | 예         | 매핑되는 개념적 모델의 엔터티 속성 이름입니다. |
